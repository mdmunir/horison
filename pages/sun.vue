                ...
                <div class="row">
                    <div class="col-lg-4 col-sm-12">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="latitude" v-model="params.latitude"
                                       placeholder="-90° sampai 90°">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="longitude" class="col-sm-4 col-form-label">Longitude</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="longitude" v-model="params.longitude"
                                       placeholder="-180° sampai 180°">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="dari" class="col-sm-4 col-form-label">Dari</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="dari" v-model="params.from"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="sampai" v-model="params.to"
                                       placeholder="YYYY-MM-dd HH:mm:ss">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group mb-3">
                                    <input type="number" class="form-control" id="interval" v-model="params.interval">
                                    <div class="input-group-append">
                                        <button type="button" class="btn btn-warning dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                            {{units[params.unit].label}}
                                        </button>
                                        <ul class="dropdown-menu" style="">
                                            <li v-for="(v,k) in units"  class="dropdown-item">
                                                <a @click="params.unit = k" href="javascript:void(0)"><i class="fa fa-check" v-if="params.unit == k"></i>{{v.label}}</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
...
<script>
    import {sunList, strToJD, R2D, toGlobe, filterObj} from '@/libs/horison';
    ...
    export default {
        ...
        methods: {
            submit() {
                const query = Object.assign({}, this.$route.query, filterObj(this.params));
            ...
            calcList() {
                ...
                if (jd1 && jd2) {
                    ...
                    this.rows = sunList(jd1, jd2, step, g).map(v => {
